...
class TestTopLevelFunctions(unittest.TestCase):
    ...
    def test_contains_sum2(self):
        """
        self = data_structures.arrays.prefix_sum.PrefixSum
        target_sum = -170140534423361914878233737403842953216 (mutated from min)
        """
        prefix_sum = data_structures.arrays.prefix_sum.PrefixSum([])
        
        actual = prefix_sum.contains_sum(-170140534423361914878233737403842953216)
