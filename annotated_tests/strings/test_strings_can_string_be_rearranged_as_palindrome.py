...
class TestTopLevelFunctions(unittest.TestCase):
    ...
    # region Test suites for executable strings.can_string_be_rearranged_as_palindrome.benchmark
    ...
    def test_benchmark_with_exception(self):
        ...
        input_str = 'seonds'
        """
        # This test fails because function [strings.can_string_be_rearranged_as_palindrome.benchmark] produces [UnicodeEncodeError]
        strings.can_string_be_rearranged_as_palindrome.benchmark("seonds")
    # endregion
