...
class TestTopLevelFunctions(unittest.TestCase):
    # region Test suites for executable compression.lempel_ziv_decompress.read_file_binary
    ...
    def test_read_file_binary(self):
        ...
        file_path = 'pythön'
        """
        actual = compression.lempel_ziv_decompress.read_file_binary("pythön")
        
        self.assertEqual('01000000', actual)
    
    def test_read_file_binary1(self):
        """
        file_path = '€'
        """
        actual = compression.lempel_ziv_decompress.read_file_binary("../€")
    ...
    def test_compress(self):
        """
        source_path = 'fo'
        destination_path = 'abcdefghijklmnMopqrst'
        """
        actual = compression.lempel_ziv_decompress.compress("fo", "abcdefghijklmnMopqrst")
