...
class TestTopLevelFunctions(unittest.TestCase):
    ...
    def test_quick_sort3(self):
        ...
        array = builtins.list[builtins.int]
        """
        actual = samples.quick_sort.quick_sort([170141183460469212842221372237303250687, 170141183460469231731687303715884105727])
        
        self.assertEqual([170141183460469212842221372237303250687, 170141183460469231731687303715884105727], actual)
    # endregion
