...
class TestTopLevelFunctions(unittest.TestCase):
    ...
    def test_binary_recursive_with_exception1(self):
        """
        decimal = '€'
        """
        # This test fails because function [conversions.decimal_to_binary_recursion.binary_recursive] produces [ValueError]
        conversions.decimal_to_binary_recursion.binary_recursive("€")
    # endregion
