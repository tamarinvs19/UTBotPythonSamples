...
class TestTopLevelFunctions(unittest.TestCase):
    ...
    def test_push(self):
        """
        self = data_structures.stacks.stack_with_doubly_linked_list.Stack[T]
        data = 'pyhön'
        """
        stack = data_structures.stacks.stack_with_doubly_linked_list.Stack()
        
        actual = stack.push("pyhön")
    ...
    def test___len__(self):
        """
        self = data_structures.stacks.stack_with_doubly_linked_list.Stack[typing.Any]
        """
        stack = data_structures.stacks.stack_with_doubly_linked_list.Stack()
